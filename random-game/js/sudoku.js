...
export class Sudoku {
    ...
    getDuplicatePositions(row, column, value) {
        ...
        const duplicatesInRow = this.getDuplicatePositionsInRow(
            row,
            column,
            value
        );
        const duplicatesInBox = this.getDuplicatePositionsInBox(
            row,
            column,
            value
        );
        ...
        duplicatesInBox.forEach((duplicatesInBox) => {
            if (
                duplicatesInBox.row !== row &&
                duplicatesInBox.column !== column
            )
                duplicates.push(duplicatesInBox);
        });
